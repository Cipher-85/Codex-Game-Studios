...
If the project appears fresh (no artifacts at all), use `numbered choice prompt`:
...
and offer to handle it immediately using `numbered choice prompt`. Choose the first
branch that applies:
