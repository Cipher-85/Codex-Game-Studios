...
Before reading or proposing edits to `assets/data/**`, read
...
- Read `.codex/instructions/path-rules/data-files.md`, then guide the user to
  update the relevant data file in `assets/data/` or formula in `design/balance/`
