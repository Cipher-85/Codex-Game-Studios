...
Then close with an `numbered choice prompt` widget:
...
- `user-invocable: true`
- `allowed-tools: Read, Glob, Grep, Write, Edit, Bash, numbered choice prompt`
- `model: sonnet`
