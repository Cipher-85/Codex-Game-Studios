---
name: retrospective
description: "Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration for Codex Game Studios."
---
...
If a matching file is found, use `numbered choice prompt`:
...
Then use `numbered choice prompt` to present two options:
