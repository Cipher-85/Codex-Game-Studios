---
name: studio-next
description: "Lightweight Codex Game Studios continuity router. Reads handoff, session, sprint, stage, workflow, and slice state to recommend the single best next action after a work unit."
---
...
If there are genuinely 2-3 viable lanes with similar priority, use
