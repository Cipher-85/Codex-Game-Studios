# Lead Programmer Memory Contract

Ported explicit upstream memory for the Codex-native Game Studios role.
...
- `numbered choice prompt` is a usage pattern described in skill body text — it is NOT listed
