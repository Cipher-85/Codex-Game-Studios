...
- `.codex/instructions/path-rules/*.md` files that Codex must read before
...
- Path-scoped Markdown files in `.codex/instructions/path-rules/` hold
  discipline needed before editing matching paths.
- Long procedures belong in `.codex/docs/`.
