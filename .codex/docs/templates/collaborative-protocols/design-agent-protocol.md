...
2. **Present 2-4 options with reasoning:**
   ...
   - *After the full explanation, use `numbered choice prompt` to capture the decision*
...
Use the `numbered choice prompt` tool to present decisions as a selectable UI instead of
...
**Example — multi-question batch for clarifying questions:**
  ...
  numbered choice prompt with questions:
