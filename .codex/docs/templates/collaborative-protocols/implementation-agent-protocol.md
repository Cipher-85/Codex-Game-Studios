...
2. **Ask architecture questions:**
   ...
   - *Use `numbered choice prompt` to batch constrained architecture questions*
...
Use the `numbered choice prompt` tool for architecture decisions and next-step choices.
