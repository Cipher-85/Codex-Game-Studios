...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `numbered choice prompt` to capture the decision*
...
Use the `numbered choice prompt` tool to present strategic decisions as a selectable UI.
